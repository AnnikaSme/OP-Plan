...
public class Verwaltung
{
     ...
     */
    public void ArztDatenLoeschen(int Personalnummer) //Die Daten zu einer bestimmten Person des Personales sollen gelöscht werde. Gesucht wird über die Personalnummer.
    {
    ...
    public void Eintragen (int Personalnummer, String NamePatient) 
    {
        ...
        else 
        {
            ...
            {
                while (i<personalkardiotechniker.size() && !gefunden)  
                {
                    gefunden = gesuchtA.equals(personalkardiotechniker.get(i));
                    i++;
                    if(i>= personalkardiotechniker.size())
